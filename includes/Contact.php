...
body,h1,h2,h3,h4,h5,h6,.wide {font-family: "Montserrat", sans-serif;}
  ...
  <body>
    ...
    <p>Questions? Go ahead and enquire. </p>
			 <form action="mailto:jpjoseph12@gmail.com" method="post" enctype="text/plain">
				 <p><input class="input border" type="text" placeholder="Name" name="Name" required="required"></p>
				 <p><input class="input border" type="text" placeholder="Email" name="Email" required="required"></p>
				 <p><input class="input border" type="text" placeholder="Subject" name="Subject" ></p>
